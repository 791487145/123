...
<form class="form-horizontal" role="form" action="add" enctype="multipart/form-data" method="post">
	...
	<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<p class="col-sm-4">
			<input type="text" placeholder="长度为1-6位" id="form-field-1" name="team_name"  class="col-xs-10 col-sm-5" value="">
	...
	<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<p class="col-sm-4">
			<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="" name="captain_name">
		</p>
	</div>
	<div class="bankAuth-bottom clearfix col-xs-12">
	...
	<div class="bankAuth-bottom clearfix col-xs-12">
		<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 状态：</p>
			<select name="report_status">
				<option value="0" selected>未报名</option>
