...
<h3 class="header smaller lighter blue mg-top12 mg-bottom20">修改道具</h3>


<form class="form-horizontal" role="form" action="{!! url('manage/updateProp') !!}" enctype="multipart/form-data" method="post">
	{!! csrf_field() !!}
	...
	<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<p class="col-sm-4">
			<input type="text" placeholder="长度为1-6位" id="form-field-1" name="pname"  class="col-xs-10 col-sm-5" value="{{ $icon['pname'] }}">
	...
	<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<p class="col-sm-4">
			<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{{ $icon['type'] }}" name="type">
		</p>
	</div>
