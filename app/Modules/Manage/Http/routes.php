...
Route::group(['prefix' => 'manage'], function() {
    ...
    //二手交易
    Route::get('/transactionList','SecondhandTransactionController@getTransactionList')->name('getTransactionList');//列表
    Route::get('/transactionDetail/{id}','SecondhandTransactionController@getTransactionDetail')->name('getTransactionDetail');//详情
	...
	//江湖
	Route::get('/propList','JiangHuController@propList')->name('propList');//道具列表
	Route::get('/addProp','JiangHuController@createPropShow')->name('createPropShow');//增加道具页
	Route::post('/addProp','JiangHuController@createProp');//添加书籍
	Route::get('/updateProp/{id}','JiangHuController@updatePropShow')->name('updatePropShow');//修改道具页
    Route::post('/updateProp','JiangHuController@updateProp');//修改道具

    Route::get('/propDel/{id}','JiangHuController@DeleteProp');//删除
