    ...
    CanResetPasswordContract
{
    ...
    protected $fillable = [
        'name', 'head_img','mobile','password','salt','status','email','email_status','qq_openid','wx_unionid',
        'wx_openid','sina_openid','last_login_time','type','promote_code','create_time','sign_id','activation_method','promote_num','last_login_uuid'
    ];
