...
<form class="form-horizontal" role="form" action="" method="post">
	...
	<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<p class="col-sm-4">
			<input type="text" id="form-field-1" name="name"  class="col-xs-10 col-sm-5" value="">
	...
	<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<p class="col-sm-4">
			<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="" name="url">
			<span class="help-inline col-xs-12 col-sm-7"><i class="light-red ace-icon fa fa-asterisk"></i></span>
		</p>
	</div>
	<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<p class="col-sm-4">
			<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="" name="sort">
		</p>
	</div>
	<div class="col-xs-12">
