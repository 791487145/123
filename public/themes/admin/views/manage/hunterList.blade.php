...
<div class="well">
    <form class="form-inline search-group" role="form" action="{!! url('manage/hunter') !!}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        ...
        <tbody>
            ...
            @foreach($grade as $k=>$item)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-xs btn-info" href="hunterDetail/{{ $item['id'] }}">
                            <i class="fa fa-edit bigger-120"></i>编辑
                        </a>
                        <a  href="hunterDel/{{ $item['id'] }}" title="删除" class="btn btn-xs btn-danger">
