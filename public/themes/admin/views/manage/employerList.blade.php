{{--列表--}}
<h3 class="header smaller lighter blue mg-bottom20 mg-top12">雇主等级</h3>

<div class="well">
    <form class="form-inline search-group" role="form" action="{{ URL('manage/employer') }}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        ...
        <div class="form-group search-list">
            <label for="namee" class="">所需经验值</label>
        ...
        <tbody>
            ...
            @foreach($grade as $k=>$item)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-xs btn-info" href="employerDetail/{{ $item['id'] }}">
                            <i class="fa fa-edit bigger-120"></i>编辑
                        </a>
                        <a  href="employerDel/{{ $item['id'] }}" title="删除" class="btn btn-xs btn-danger">
