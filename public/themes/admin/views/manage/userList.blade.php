            ...
            <div class="">
                <div class="form-group search-list width285">
                    ...
                    <select class="" name="status">
                        ...
                        <option @if(isset($status) && $status == 2)selected="selected"@endif value="2">已激活</option>
                        <option @if(isset($status) && $status == 3)selected="selected"@endif value="3">已禁用</option>
                    </select>
                </div>
                <div class="form-group search-list">
        ...
        <table id="sample-table" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <!-- <td>@if($item->status == 1)未激活@elseif($item->status == 2)已激活@elseif($item->status == 3)已禁用@endif</td> -->
                    <td>{!! $item->state !!}</td>
