...
<div class="widget-header mg-bottom20 mg-top12 widget-well">
    <div class="widget-toolbar no-border pull-left no-padding">
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="{!! url('manage/generalize_config') !!}" title="">添加推广配置</a>
            </li>
        </ul>
    </div>
</div>
<!--  /.page-header -->
<form class="form-horizontal" role="form" method="post" action="{!! url('manage/generalize_config') !!}">
    {!! csrf_field() !!}
    <div class="g-backrealdetails clearfix bor-border interface">
        ...
        <div class="form-group interface-bottom col-xs-12">
            ...
            <div class="col-sm-9">
                <input type="text" id="form-field-1" class="col-xs-10 col-sm-4" name="one_sum">
        ...
        <div class="form-group interface-bottom col-xs-12">
            ...
            <div class="col-sm-9">
                <input type="text" id="form-field-1" class="col-xs-10 col-sm-4" name="two_sum">
                <span class="help-inline col-xs-12 col-sm-8">
                    <span class="middle">（单位：元）</span>
                </span>
            </div>
        ...
        <div class="form-group interface-bottom col-xs-12">
            ...
            <div class="col-sm-9">
                <input type="text" id="form-field-1" class="col-xs-10 col-sm-4" name="three_sum">
                <span class="help-inline col-xs-12 col-sm-8">
                    <span class="middle">（单位：元）</span>
                </span>
            </div>
